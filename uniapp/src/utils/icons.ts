...
const paths = {
    ...
    cart: "M7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zm10 0c-1.1 0-1.99.9-1.99 2S15.9 22 17 22s2-.9 2-2-.9-2-2-2zM7.16 14h9.72c.75 0 1.41-.41 1.75-1.03L21 7H7.21L6.27 5H3v2h2l3.6 7.59L7.16 14z",
...
export const icons = {
    ...
    cart: getSvg(paths.cart, COLORS.inactive),
    cartActive: getSvg(paths.cart, COLORS.primary),
