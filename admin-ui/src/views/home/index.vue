...
const erpSummaryItems: Array<{ key: keyof ErpStats; label: string; desc: string; icon: any; tone: string; money?: boolean }> = [
  ...
  { key: 'todaySaleAmount', label: '今日销售额', desc: '今日销售单', icon: TrendCharts, tone: 'green', money: true },
  { key: 'todayPurchaseAmount', label: '今日进货额', desc: '今日进货单', icon: Money, tone: 'orange', money: true },
