      ...
      <template #header>
        <div class="card-header">
          ...
          <div>
            ...
            <el-button type="primary" @click="submit" v-permission="form.id ? 'erp:stock-check:edit' : 'erp:stock-check:add'">保存</el-button>
          </div>
        </div>
      </template>
...
import { addStockCheck, getStockCheck, nextStockCheckNo, updateStockCheck, type StockCheck, type StockCheckItem } from '@/api/erp/stock'
